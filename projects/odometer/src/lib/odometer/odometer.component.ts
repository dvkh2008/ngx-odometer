...
import { NgxOdometerConfig, NgxOdometerConfigModel } from './odometer.config';
import {
    CAR_THEME,
    DEFAULT_THEME,
    DIGITAL_THEME,
...
export class NgxOdometerComponent implements OnInit, OnDestroy, OnChanges, AfterViewInit {
    private subscription: Subscription;
    private odometer: OdometerModel;
    @ViewChild('container', { read: ElementRef }) container: ElementRef;
    @Input() number: number; // Required
    @Input() config: NgxOdometerConfigModel = {};
    ...
    private initConfig() {
        this.config = _.defaults(this.config, new NgxOdometerConfig());
